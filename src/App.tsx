...
import LoagindComp from './LoadingComp';
  ...
  return (
    <>
      <div className="container text-white p-3">
        ...
        <div id="imagem" style={{ minHeight: '500px' }} className="border rounded bg-white h-auto d-flex justify-content-center align-items-center mt-4 text-black">
